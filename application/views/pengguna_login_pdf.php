...
if(isset($data_cetak) && count($data_cetak)){
	$html .= "<p><h3>DAFTAR PENGGUNA LOGIN (SIMPEG 2011)</h3></p>";
	$html .= "<table border='1' width='100%' style='border-collapse: collapse;'>\n";
	$html .= "<tr>";
	$html .= "<td class='ClsTh'>NO</td>";
	$html .= "<td class='ClsTh'>PENGGUNA</td>";
	$html .= "<td class='ClsTh'>NAMA LENGKAP</td>";
	$html .= "<td class='ClsTh'>E-MAIL</td>";
	$html .= "<td class='ClsTh'>TIPE</td>";
	$html .= "<td class='ClsTh'>TANGGAL TERDAFTAR</td>";
	$html .= "<td class='ClsTh'>KUNJUNGAN TERAKHIR</td>";
	$html .= "<td class='ClsTh'>STATUS</td>";
	$html .= "</tr>";
	$html .= "<tr>";
	$html .= "<td class='ClsTh2'>1</td>";
	...
	foreach($data_cetak as $key => $list){
		...
		$html .= "<tr valign='top' $tr_param  class='trData'>";
		$html .= "<td class='centers' width='25'>".$i."</td>";
		$html .= "<td class='texts'>".$list['user']."</td>";
		$html .= "<td class='texts'>".$list['fullname']."</td>";
		$html .= "<td class='texts'>".$list['email']."</td>";
		$html .= "<td class='texts'>".$list['type']."</td>";
		$html .= "<td class='centers'>".$list['registerDate']."</td>";
		$html .= "<td class='centers'>".$list['lastvisitDate']."</td>";
		$html .= "<td class='centers'>".$list['status']."</td>";
		$html .= "</tr>";		
	}		
...
// pdf_create(gzcompress($html,9), $filenamez);
	$filenamez = $this->session->userdata('iduser_zs_simpeg')."_pengguna_login";
