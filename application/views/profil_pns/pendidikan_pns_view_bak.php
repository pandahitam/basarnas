...
// ARSIP DIGITAL ------------------------------------------------------- START
var Image_Arsip_Pddk = new Ext.Component({autoEl: {tag: 'img', src: './assets/images/preview.png' + '?dc=' + new Date().getTime(), id: 'Image_Arsip_Pddk', width: 265, height: 360}});
var Form_Arsip_Pddk = new Ext.create('Ext.form.Panel', {
	...
	frame: true, title: 'Upload', width: 70, margins: '0 5 0 0',
	items: [
		...
		{xtype: 'fileuploadfield', name: 'filearsip', id:'filearsip_Pddk', buttonOnly: true, buttonText: '.Browse.', hideLabel: true,
		 listeners: {
		 	'change': function(){
		...
		{xtype: 'button', text: '..Hapus..', tooltip: {text: 'Hapus Arsip Digital'}, handler: function() {Reset_Arsip_Pddk();}}
	]
});

function Set_Arsip_Pddk(){Set_Arsip_Digital('Form_Pendidikan_PNS', 'Image_Arsip_Pddk', 'IDP_Pddk', 2, 'pendidikan');}
function Reset_Arsip_Pddk(){Reset_Arsip_Digital('Form_Pendidikan_PNS', 'Image_Arsip_Pddk', 'IDP_Pddk', 2, 'pendidikan'); Deactive_Form_Pendidikan_PNS();}
  ...
  items: [
  	{xtype: 'fieldcontainer', layout: 'hbox', 
  	 items: [
    	 ...
    	 items: [
	  		{xtype: 'fieldset', title: 'Data Pendidikan', defaultType: 'textfield', defaults: {labelWidth: 120, labelAlign: 'left'}, margins: '0 5 0 0', style: 'padding: 0 5px 0 5px;',
			    ...
			    {xtype: 'fieldcontainer', layout: 'hbox', fieldLabel: 'Status, Akreditas', defaults: {hideLabel: true}, combineErrors: false,
			     ...
			     items: [
				    {xtype: 'combobox', fieldLabel: 'Status', name: 'status_institusi', margin: '0 5 0 0', width: 80,
			    ...
			    {xtype: 'fieldcontainer', layout: 'hbox', fieldLabel: 'Tahun Masuk', defaults: {hideLabel: true}, combineErrors: false,
			     ...
			     items: [
			    	{fieldLabel: 'Tahun Masuk', name: 'tahun_masuk', value: 0, minValue: 0, margins: '0 5 0 0', width: 65},
			     	{fieldLabel: 'Tahun Lulus', name: 'tahun_lulus', value: 0, minValue: 0, hideLabel: false, labelWidth: 100, labelAlign: 'right', width:170},
			     ]
			    },
    	...
    	//{xtype: 'fieldset', margins: '0 5px 0 0', style: 'padding: 0 0 0 0; border-width: 0px;', width: 285,
    	// items: [
		  //	{xtype: 'fieldset', title: 'Arsip Digital', width: 275, height: 380, margins: '0 0 0 0', style: 'padding: 0 5px 5px 5px; text-align: center;',
		  //	 items: [Image_Arsip_Pddk]
		  //	},
    	// ]
    	//},
    	{xtype: 'fieldset', margins: '0 5px 0 0', style: 'padding: 0 0 0 0; border-width: 0px;', width: 70, height: 150,
    	 items: [
		  	{xtype: 'fieldset', margins: '0 0 0 0', style: 'padding: 0; border-width: 0px; text-align: center;',
		  	 items: [Form_Arsip_Pddk]
		  	},    	 
		  	{xtype: 'fieldset', id: 'Frame_Cetak_Arsip_Pddk', margins: '0 0 0 0', height: 30, style: 'padding: 3px 0 0 0; text-align: center;', hidden: true,
		  	 items: [{xtype: 'button', id: 'Btn_Cetak_Arsip_Pddk', text: '..Cetak..', tooltip: {text: 'Cetak Arsip Digital'}, handler: function() {Cetak_Arsip_Pddk();}}]
		  	},
		  	{xtype: 'fieldset', id: 'Frame_Download_Arsip_Pddk', margins: '0 0 0 0', height: 30, style: 'padding: 3px 0 0 0; text-align: center;', hidden: true,
		  	 items: [{xtype: 'button', id: 'Btn_Download_Arsip_Pddk', text: 'Download', tooltip: {text: 'Download Arsip Digital'}, handler: function() {Download_Arsip_Pddk();}}]
		  	},
    	 ]
    	},
     ]
...
function Profil_PNS_Tambah_Pddk(){
	...
	Image_Arsip_Pddk.el.dom.src = './assets/images/preview.png' + '?dc=' + new Date().getTime();
