...
<?php if (isset($jsscript) && $jsscript == TRUE) { ?>
    ...
    /////////
        ...
        InventoryPenerimaan.Action.add = function() {
            ...
            Modal.processCreate.setTitle('Create InventoryPenerimaan');
        ...
        InventoryPenerimaan.Action.edit = function() {
            ...
            if (selected.length === 1)
            {
                ...
                {
                    Modal.processEdit.setTitle('Edit InventoryPenerimaan');
                }
        ...
        InventoryPenerimaan.Action.print = function() {
            ...
            var serverSideModelName = "InventoryPenerimaan_Model";
            var title = "InventoryPenerimaan Umum";
            var primaryKeys = "id";
