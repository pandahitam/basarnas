...
if(isset($data_cetak) && count($data_cetak)){
	$html .= "<p><h3>.:: DAFTAR NAMA KECAMATAN</h3></p>";
	...
	$html .= "<td class='ClsTh'>NAMA KABUPATEN/KOTA</td>";
	$html .= "<td class='ClsTh'>NAMA KECAMATAN</td>";
	$html .= "</tr>";
	$html .= "<tr>";
	...
	foreach($data_cetak as $key => $list){
			...
			$html .= "<td class='centers'>".$list['kode_kec']."</td>";
			$html .= "<td class='texts'>".$list['nama_prov']." (".$list['kode_prov'].")</td>";
			$html .= "<td class='texts'>".$list['nama_kabkota']." (".$list['kode_kabkota'].")</td>";
			$html .= "<td class='texts'>".$list['nama_kec']."</td>";
			$html .= "</tr>";
	}		
	$html .= "</tbody>";
