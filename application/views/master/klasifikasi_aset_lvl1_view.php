...
<?php if (isset($jsscript) && $jsscript == TRUE) { ?>
    ...
    /////////
        ...
        KlasifikasiAsetLvl1.URL = {
            ...
            update: BASE_URL + 'master_data/klasifikasi_aset_lvl1_modifyKlasifikasiAsetLvl1',
            create: BASE_URL + 'master_data/klasifikasi_aset_lvl1_createKlasifikasiAsetLvl1',
        ...
        KlasifikasiAsetLvl1.Data = new Ext.create('Ext.data.Store', {
            id: 'Data_KlasifikasiAsetLvl1', storeId: 'DataKlasifikasiAsetLvl1', model: 'MKlasifikasiAsetLvl1', pageSize: 50, noCache: false, autoLoad: true,
        ...
        KlasifikasiAsetLvl1.Form.create = function(data, edit) {
            ...
            {
                var setting = {
                    url: KlasifikasiAsetLvl1.URL.update,
            ...
            {
                var setting = {
                    url: KlasifikasiAsetLvl1.URL.create,
                    data: KlasifikasiAsetLvl1.Data,
                    isEditing: edit,
                };
            }
        ...
        KlasifikasiAsetLvl1.Action.remove = function() {
            ...
            Ext.Msg.show({
                title: 'Konfirmasi',
                msg: 'Apakah Anda yakin untuk menghapus ? Data lvl 2 dan lvl 3 yang berhubungan juga akan terhapus.',
                ...
                fn: function(btn) {
                    if (btn === 'yes')
                    {
                        ...
                        $.ajax({
                            ...
                            data: dataSend,
                            dataType: 'json',
                            url:  KlasifikasiAsetLvl1.URL.remove,
                            success: function(data) {
                                /*var a = dataGrid;
                                 debugger;*/
                                console.log('success to delete');
                                 KlasifikasiAsetLvl1.Data.load();
                            }
                        });
                    }
                }
