...
if(isset($data_cetak) && count($data_cetak)){
	$html .= "<p><h3>.:: DAFTAR NAMA JABATAN</h3></p>";
	
	$i = 0;
	$data_group = "*";
	foreach($data_cetak as $key => $list){
		if($data_group != $list['jenis_jab']){
			$i = 0;
			if($data_group != $list['jenis_jab'] && $data_group != "*"){$html .= "</tbody></table></div>";}
			if($data_group != "*"){$html .= "<div style='page-break-before: always;'></div>";}
			$data_group = $list['jenis_jab'];
			$html .= "<div id='BoxTbl'>";
			$html .= "<table width='100%' style='border-collapse: collapse;'>\n";
			$html .= "<tr><td colspan='5' class='ClsGroup'>JENIS JABATAN : ".$list['jenis_jab']."</td></tr>";
			$html .= "<thead>";
			$html .= "<tr>";
			$html .= "<td class='ClsTh_start' width='25'>NO</td>";
			$html .= "<td class='ClsTh' width='40'>KODE</td>";
			$html .= "<td class='ClsTh'>NAMA JABATAN</td>";
			$html .= "<td class='ClsTh'>KELOMPOK</td>";
			$html .= "<td class='ClsTh' width='40'>ESELON</td>";
			$html .= "</tr>";
			$html .= "<tr>";
		...
		$html .= "<td class='centers'>".$list['kode_jab']."</td>";
		$html .= "<td class='texts'>".$list['nama_jab']."</td>";
		$html .= "<td class='texts'>".$list['klp_jab']."</td>";
...
$filenamez = $this->session->userdata('iduser_zs_simpeg')."_jab";
