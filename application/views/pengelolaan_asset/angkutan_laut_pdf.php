...
if(isset($dataprn) && count($dataprn)){	
    ...
    if (!empty($row['image_url'])) {
      ...
      $html .= "<div id='subtitle_profil'>III. DETAIL ANGKUTAN</div>";
		$html .= "<div id='BoxTbl'>";
		$html .= "<table width='100%' class='report' style='border-collapse: collapse;'>\n";
		$html .= "<tbody>";
      ...
      $html .= "<div id='title_profil'><br><br>DATA TAMBAHAN</div>";
	   $html .= "<div id='subtitle_profil'>STKK</div>";
		$html .= "<div id='BoxTbl'>";
		...
		$html .= "<div id='subtitle_profil'>Surat Ukur</div>";
		$html .= "<div id='BoxTbl'>";
		$html .= "<table width='90%' class='report' style='border-collapse: collapse;'>\n";
		$html .= "<tbody>";
		...
		$html .= "<div id='subtitle_profil'>Sertifikasi Keselamatan</div>";
		$html .= "<div id='BoxTbl'>";
		$html .= "<table width='90%' class='report' style='border-collapse: collapse;'>\n";
		$html .= "<tbody>";
		...
		$html .= "<div id='subtitle_profil'>Sertifikasi Radio</div>";
		$html .= "<div id='BoxTbl'>";
		$html .= "<table width='90%' class='report' style='border-collapse: collapse;'>\n";
		$html .= "<tbody>";
      ...
      $html .= "<div style='page-break-before: always;'></div>";
		...
		$html .= "<div id='subtitle_profil'>Surat Ijin Berlayar</div>";
		$html .= "<div id='BoxTbl'>";
		$html .= "<table width='90%' class='report' style='border-collapse: collapse;'>\n";
		$html .= "<tbody>";
      ...
      $html .= "<br>";
      $html .= "<div id='subtitle_profil'>Perlengkapan Angkutan Laut</div>";
		$html .= "<div id='BoxTbl'>";
		$html .= "<table width='100%' class='report' style='border-collapse: collapse;'>\n";
		$html .= "<tbody>";
      ...
      $html .= "<div id='title_profil'>PENDAYAGUNAAN</div>";
      $html .= "<div id='subtitle_profil'></div>";
		$html .= "<div id='BoxTbl'>";
		$html .= "<table width='100%' class='report' style='border-collapse: collapse;'>\n";
		$html .= "<tbody>";
...
pdf_create(gzcompress($html,9), "SIMASS BASARNAS - Angkutan Laut", false);
