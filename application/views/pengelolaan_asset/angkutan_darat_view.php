...
//        });
        ...
        AngkutanDarat.URL = {
            ...
            createUpdateDetailPenggunaanAngkutan: BASE_URL + 'asset_angkutan_detail_penggunaan/modifyDetailPenggunaanAngkutanDarat',
            removeDetailPenggunaanAngkutan: BASE_URL + 'asset_angkutan_detail_penggunaan/deleteDetailPenggunaanAngkutanDarat',
        ...
        AngkutanDarat.proxy = new Ext.create('Ext.data.AjaxProxy', {
            ...
            afterRequest: function(request, success) {
                ...
                if(success == true)
                {
                    ...
                    var total_asset_field = Ext.getCmp('total_grid_AngkutanDarat');
                ...
                fn: function(btn) {
                    if (btn === 'yes')
                    {
                        ...
                        $.ajax({
                            ...
                            data: dataSend,
                            dataType: 'json',
                            url: AngkutanDarat.URL.removePerlengkapanAngkutanDarat,
                            success: function(data) {
                                /*var a = dataGrid;
                                 debugger;*/
                                console.log('success to delete');
                                AngkutanDarat.dataStorePerlengkapanAngkutanDarat.load();
                            }
                        });
...
//                        var data = {id_collection:ids};
                        ...
                        var form = Form.panelVerySmallAngkutan(AngkutanDarat.URL.removePerlengkapanAngkutanDarat, AngkutanDarat.dataStorePerlengkapanAngkutanDarat,arrayDeleted);                       
         ...
         AngkutanDarat.addDetailPenggunaan = function()
        {
            ...
            if (selected.length === 1)
            {
                ...
                if (Modal.assetSecondaryWindow.items.length === 0)
                {
                    ...
                    form.insert(0, Form.Component.dataDetailPenggunaanAngkutan(data.id,'darat',false));
                    Modal.assetSecondaryWindow.add(form);
                    Modal.assetSecondaryWindow.show();
        ...
        AngkutanDarat.editDetailPenggunaan = function()
        {
            ...
            if (selected.length === 1)
            {
                ...
                if (Modal.assetSecondaryWindow.items.length === 0)
                {
                    ...
                    form.insert(0, Form.Component.dataDetailPenggunaanAngkutan(data.id,'darat',true));
