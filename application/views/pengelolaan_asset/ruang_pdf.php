...
if(isset($dataprn) && count($dataprn)){	
    ...
    if (!empty($row['image_url'])) {
      ...
      $html .= "<div id='subtitle_profil'><br><br>I. KLASIFIKASI ASET</div>";
		$html .= "<div id='BoxTbl'>";
		$html .= "<table width='100%' class='report' style='border-collapse: collapse;'>\n";
		$html .= "<tbody>";
		$html .= "<tr><td width='100'>Level I</td><td>".$row['kd_lvl1']."</td></tr>";
		$html .= "<tr><td width='100'>Level II</td><td>".$row['kd_lvl2']."</td></tr>";
		$html .= "<tr><td width='100'>Level III</td><td>".$row['kd_lvl3']."</td></tr>";
		$html .= "</tbody>";
		$html .= "</table>";
		$html .= "</div>";
      
      $html .= "<div id='subtitle_profil'><br><br>II. RUANG SELECTION</div>";
		$html .= "<div id='BoxTbl'>";
		$html .= "<table width='100%' class='report' style='border-collapse: collapse;'>\n";
		$html .= "<tbody>";
		$html .= "<tr><td width='100'>Ruang</td><td>".$row['kd_ruang']."</td></tr>";
		$html .= "</tbody>";
		$html .= "</table>";
		$html .= "</div>";    
      
	  $html .= "<div id='subtitle_profil'><br><br>III. GAMBAR</div>";
		$html .= "<div id='BoxTbl'>";
		$html .= "<table width='100%' class='report' style='border-collapse: collapse;'>\n";
		$html .= "<tbody>";
      if (count($gambar) > 0) {
