...
if(isset($dataprn) && count($dataprn)){	
   ...
   if (!empty($row['image_url'])) {
      ...
      $html .= "<div id='subtitle_profil'><br><br>III. DETAIL BANGUNAN</div>";
		$html .= "<div id='BoxTbl'>";
		$html .= "<table width='100%' class='report' style='border-collapse: collapse;'>\n";
		$html .= "<tbody>";
      ...
      $html .= "<tr><td>Tanggal IMB</td><td>".$row['tgl_imb']."</td></tr>";
		$html .= "</tbody>";
		$html .= "</table>";
		$html .= "</div>";
...
pdf_create(gzcompress($html,9), "SIMASS BASARNAS - Perairan", false);
