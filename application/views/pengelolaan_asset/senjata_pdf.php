...
if(isset($dataprn) && count($dataprn)){	
    ...
    if (!empty($row['image_url'])) {
      ...
      $html .= "<div id='subtitle_profil'><br><br>III. DETAIL ALAT / KENDARAAN</div>";
		...
		$html .= "<table width='100%' class='report' style='border-collapse: collapse;'>\n";
		$html .= "<tbody>";
		$html .= "<tr><td width='100'>Nama</td><td>".$row['nama']."</td></tr>";
      $html .= "<tr><td>Merek</td><td>".$row['merk']."</td></tr>";
		$html .= "<tr><td>Tipe</td><td>".$row['type']."</td></tr>";
      $html .= "<tr><td>Kaliber</td><td>".$row['kaliber']."</td></tr>";
      $html .= "<tr><td>No Pabrik</td><td>".$row['no_pabrik']."</td></tr>";
      ...
      $html .= "<div id='subtitle_profil'><br><br>III. DETAIL SENJATA</div>";
		$html .= "<div id='BoxTbl'>";
		$html .= "<table width='100%' class='report' style='border-collapse: collapse;'>\n";
		$html .= "<tbody>";
		$html .= "<tr><td width='100'>Surat</td><td>".$row['surat']."</td></tr>";
		$html .= "<tr><td>Tanggal Surat</td><td>".$row['tgl_surat']."</td></tr>";
		$html .= "</tbody>";
		$html .= "</table>";
		$html .= "</div>";
