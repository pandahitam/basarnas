...
class CPDF_Adapter implements Canvas {
   ...
   */
  protected function _add_page_text($first_page = true) {
    ...
    foreach ($this->_pages as $pid) {
        ...
        switch ($_t) {
          case "text":
            ...
            //$text = str_replace(array("{PAGE_NUM}","{PAGE_COUNT}"), array($page_number, $this->_page_count), $text);
          	...
          	// Patched By Oppie
            $text = ($first_page == false && $page_number == 1) ? "" : str_replace(array("{PAGE_NUM}","{PAGE_COUNT}"), array($page_number, $this->_page_count), $text);
		        if($first_page == false && $page_number == 1){
		        }else{
            	$this->text($x, $y, $text, $font, $size, $color, $word_space, $char_space, $angle);
		        }
            break;
      ...
      // Patched By Oppie
      switch($page_number){
      	case 11: case 17: case 21: case 27: case 31: case 37: case 41: case 47: case 51: case 57: case 61: case 67: case 71: case 77: case 81: case 87: case 91: case 97: case 101: case 107: case 500:
      		sleep(1); break;
      	default:
      }
   ...
   */
  function stream($filename, $options = null, $first_page = true) {
    // Add page text
    $this->_add_page_text($first_page);
   ...
   * @return string
   */
  function output($options = null, $first_page = true) {
    $this->_add_page_text($first_page);
