...
class Rak_Model extends MY_Model{
	...
	function __construct(){
            ...
            $this->viewTable = 'view_referensi_penyimpanan_rak';
            $this->selectColumn = "SELECT id, warehouseruang_id, warehouse_id, nama, nama_ruang, 
                nama_warehouse, nama_unker, nama_unor,kd_lokasi, kode_unor";
	}
            ...
            if($start !=null && $limit !=null)
            {
                ...
                if($searchByField != null)
                {
                    $query = "$this->selectColumn
                                ...
                                nama_ruang like '%$searchByField%' OR
