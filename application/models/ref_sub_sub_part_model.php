<?php
class Ref_Sub_Sub_Part_Model extends MY_Model {
	function __construct(){
		parent::__construct();
            $this->table = 'ref_sub_sub_part';    
            $this->viewTable = 'view_referensi_sub_sub_part';
            ...
            if($start !=null && $limit !=null)
            {
                ...
                if($searchByField != null)
                {
                    $query = "$this->selectColumn
                                ...
                                sub_part_induk like '%$searchByField%' OR
