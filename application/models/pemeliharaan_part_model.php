...
//                $this->countTable = 'pemeliharaan_part';
                ...
                $this->selectColumn = "SELECT t.id, t.id_pemeliharaan, t.id_penyimpanan, t.id_penyimpanan_data_perlengkapan,
                                       t.qty_pemeliharaan,c.part_number,c.nama";
	}
...
//		return $this->Get_By_Query($query);	
	...
	function get_PemeliharaanParts($id_pemeliharaan)
	{
		$query = "$this->selectColumn FROM pemeliharaan_part as t 
