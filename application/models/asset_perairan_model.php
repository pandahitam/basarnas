...
class Asset_Perairan_Model extends MY_Model{
	...
	function __construct(){
		...
		$this->table = 'asset_perairan';
                ...
                $this->viewTable = 'view_asset_perairan';
...
//                            f.kd_lvl1,f.kd_lvl2,f.kd_lvl3";
                $this->selectColumn = "SELECT kd_lokasi, kd_brg, no_aset, kuantitas, rph_aset, no_kib, luas_bdg, luas_dsr, kapasitas, thn_sls, 
...
//            else if($searchByField != null)
//            {
//                return $this->Get_By_Query($query,false,'view_asset_perairan');	
//            }
//            else
//            {
//                return $this->Get_By_Query($query);	
