<?php
class Asset_Alatbesar_Model extends MY_Model{
	
	function __construct(){
		parent::__construct();
		$this->table = 'asset_alatbesar';
                $this->extTable = "ext_asset_alatbesar";
                $this->viewTable = "view_asset_alatbesar";
//                $this->selectColumn = "SELECT t.kd_lokasi, t.kd_brg, t.no_aset, kuantitas, no_kib, merk, type, pabrik, thn_rakit, thn_buat, negara, kapasitas, 
...
//                            f.kd_lvl1,f.kd_lvl2,f.kd_lvl3";
                $this->selectColumn = "SELECT kd_lokasi, kd_brg, no_aset, kuantitas, no_kib, merk, type, pabrik, thn_rakit, thn_buat, negara, kapasitas, 
                            sis_opr, sis_dingin, sis_bakar, duk_alat, pwr_train, no_mesin, no_rangka, lengkap1, lengkap2, lengkap3, jns_trn, dari, tgl_prl, rph_aset, 
                            dasar_hrg, sumber, no_dana, tgl_dana, unit_pmk, alm_pmk, catatan, kondisi, tgl_buku, rphwajar, status,
...
//            else if($searchByField != null)
//            {
//                return $this->Get_By_Query($query,false,'view_asset_alatbesar');	
//            }
//            else
//            {
//                return $this->Get_By_Query($query);	
