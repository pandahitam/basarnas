<?php
class laporan_angkutan_udara extends MY_Controller {
...
//		$this->model = $this->Asset_Alatbesar_Model;		
        ...
        public function index()
        {
			...
			$data['jsscript'] = TRUE;
			$this->load->view('laporan/laporan_angkutan_udara_view',$data);
		}else{
			$this->load->view('laporan/laporan_angkutan_udara_view');
		}
	}
